  ...
  return (
    <div className="overflow-hidden rounded-lg">
      <div className="px-3.5 py-3">
        {title && (
          <div className="mb-2 text-left font-semibold text-chart-tooltip-foreground text-xs tracking-wide border-b border-white/10 pb-1.5">
            {title}
          </div>
        )}
          ...
          {rows.map((row) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-chart-tooltip-muted text-xs font-medium">
                  {row.label}
                </span>
              </div>
              <span className="font-bold text-chart-tooltip-foreground text-xs tabular-nums tracking-tight">
