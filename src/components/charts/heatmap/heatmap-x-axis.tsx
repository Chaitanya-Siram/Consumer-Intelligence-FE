...
export const HeatmapXAxis = memo(function HeatmapXAxis({
  ...
  // Sit month labels just above the grid, so quarter labels (drawn higher via
  // HeatmapSeparator startOffset) stack above them — matching the reference.
  const monthTop = Math.max(margin.top - 18, 0);
